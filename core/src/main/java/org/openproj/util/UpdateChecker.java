...
public class UpdateChecker {
	...
	private static final String updateAddress = "http://www.openproj.org/versions/version-"+UPDATE_CHECKER_VERSION;
	private static final String downloadAddress = "http://sourceforge.net/project/showfiles.php?group_id=199315";
