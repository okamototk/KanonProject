...
public class DynamicSelect extends Select implements Finder {
	private static Log log = LogFactory.getLog(DynamicSelect.class);
	/**
	 *
	 */
	...
	public Object[] getKeyArrayWithoutNull(Object object) {
		try {
			return (Object[]) listMethod.invoke(null,new Object[] {object});
		} catch (Exception e) {
			log.error("Error calling keyArrayFromMethod for:" + listMethod,e);
			return null;
		}
	}

	public List getValueListWithoutNull(Object object){
	...
	public void setList(String methodName) {
		listMethod = ClassUtils.staticMethodFromFullName(methodName, new Class[] {Object.class});
		if (listMethod == null)
			log.error("invalid method in select:" + methodName);
	}
	public void setFinder(String finderName) {
		finderMethod = ClassUtils.staticMethodFromFullName(finderName, new Class[] {String.class,Object.class});
		if (finderMethod == null)
			log.error("invalid method in select:" + finderName);
	}
	 ...
	 */
	public Object getKey(Object arg0,Object obj) {
	...
	public Object find(Object key, Collection container) {
		...
		try {
			return finderMethod.invoke(object, new Object[] {name,null});
		} catch (Exception e) {
			return null;
		}
	}
