...
public class StaticSelect extends Select {
	...
	private synchronized void populateIfLazy(Object obj) {
		if (populateMethod != null) {
			Boolean result = false;
			Method m = 	ClassUtils.staticMethodFromFullName(populateMethod, new Class[]{getClass(),Object.class});
			try {
				result = (Boolean) m.invoke(null,new Object[]{this,obj});
			} catch (Exception e) {
				e.printStackTrace();
			}
			if (result)
