...
public class FieldContext implements HasStartAndEnd {
	...
	private boolean hideNullValues = false;
	private boolean nullIfUnchanged = false;
	private boolean convertResult = true;
	...
	public boolean isNullIfUnchanged() {
		return nullIfUnchanged;
	}
	public void setNullIfUnchanged(boolean nullIfUnchanged) {
		this.nullIfUnchanged = nullIfUnchanged;
	}
	public boolean isHideNullValues() {
		return hideNullValues;
	}
	public void setHideNullValues(boolean hideNullValues) {
	...
	private static FieldContext soapInstance = null;
	...
	public static FieldContext getSoapInstance() {
		if (soapInstance == null) {
			soapInstance = new FieldContext();
			soapInstance.setSoap(true);
			soapInstance.setForceValue(true);
		}
		return soapInstance;
	}
	...
	public static boolean isFullRange(long s, long e) {
		return s == defaultStart && e == defaultEnd;
	}
