...
//	protected long externalId;
	...
	protected Closure endSwingClosure,rawObjectClosure;
	protected int format;
	protected int persistenceType;
	protected boolean skipCalendars = false;
	...
	public boolean isSkipCalendars() {
		return this.skipCalendars;
	}
	public void setSkipCalendars(boolean skipCalendars){
		this.skipCalendars = skipCalendars;
	}
	public long getId() {
		return id;
	}
	...
	public Closure getRawObjectClosure() {
		return rawObjectClosure;
	}
	public void setRawObjectClosure(Closure rawObjectClosure) {
		this.rawObjectClosure = rawObjectClosure;
	}
