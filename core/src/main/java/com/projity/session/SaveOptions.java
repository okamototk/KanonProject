...
public class SaveOptions implements Cloneable{
	...
	protected boolean readActualsFirst = true;
	protected Collection result;
	protected Closure resultClosure;
	...
	public Closure getResultClosure() {
		return resultClosure;
	}
	public void setResultClosure(Closure resultClosure) {
	...
	public boolean isReadActualsFirst() {
		return readActualsFirst;
	}
	public void setReadActualsFirst(boolean readActualsFirst) {
		this.readActualsFirst = readActualsFirst;
	}
