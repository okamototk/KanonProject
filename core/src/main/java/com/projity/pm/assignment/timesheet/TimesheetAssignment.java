...
public class TimesheetAssignment implements Schedule, AssignmentSpecificFields, TimeDistributedFields, UpdatesFromTimesheet, HasCssStyle, CanBeDirty, Comparable, HasNotes {
	...
	public long getEstimatedFinish() {
		return assignment.getEstimatedFinish();
	}

	public double getEstimatedPercentComplete() {
		return assignment.getEstimatedPercentComplete();
	}

	public long getEstimatedRemainingWork() {
		return assignment.getEstimatedRemainingWork();
	}

	public long getEstimatedStart() {
		return assignment.getEstimatedStart();
	}

	public long getEstimatedWork() {
		return assignment.getEstimatedWork();
	}
	...
	public boolean isReadOnlyCost(FieldContext fieldContext) {
		return assignment.isReadOnlyCost(fieldContext);
	}

	public void setCost(double cost, FieldContext fieldContext) {
		assignment.setCost(cost, fieldContext);
	}
	public double getPercentWorkComplete() {
		return assignment.getPercentWorkComplete();
	}

	public boolean isTimesheetClosed() {
		return assignment.isTimesheetClosed();
	}

	public boolean isTimesheetComplete() {
		return assignment.isTimesheetComplete();
	}

	public void setTimesheetClosed(boolean timesheetClosed) {
		assignment.setTimesheetClosed(timesheetClosed);
	}

	public void setTimesheetComplete(boolean timesheetComplete) {
		assignment.setTimesheetComplete(timesheetComplete);
	}

	public boolean fieldHideTimesheetClosed(FieldContext fieldContext) {
		return assignment.fieldHideTimesheetClosed(fieldContext);
	}
	...
	public boolean isReadOnlyCompletedThrough(FieldContext context) {
		// TODO Auto-generated method stub
		return assignment.isReadOnlyCompletedThrough(context);
	}

	public boolean isReadOnlyComplete(FieldContext context) {
		return assignment.isReadOnlyComplete(context);
	}

	public boolean isReadOnlyTimesheetClosed(FieldContext fieldContext) {
		return assignment.isReadOnlyTimesheetClosed(fieldContext);
	}
}
