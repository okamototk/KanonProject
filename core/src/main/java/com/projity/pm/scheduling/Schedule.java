...
//    void setDurationActive(long durationActive);
	...
	boolean isReadOnlyActualStart(FieldContext fieldContext);
	
	long getActualFinish();
	void setActualFinish(long actualFinish);
	boolean isReadOnlyActualFinish(FieldContext fieldContext);

	long getActualDuration();
	void setActualDuration(long actualDuration);
	boolean isReadOnlyActualDuration(FieldContext fieldContext);
	...
	boolean isReadOnlyCompletedThrough(FieldContext context);
	...
	void setTimesheetComplete(boolean timesheetComplete);
	boolean isTimesheetClosed();
	void setTimesheetClosed(boolean timesheetClosed);
	boolean fieldHideTimesheetClosed(FieldContext fieldContext);
	boolean isReadOnlyTimesheetClosed(FieldContext fieldContext);
}
