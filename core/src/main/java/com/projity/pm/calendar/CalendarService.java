	...
	public void add(WorkingCalendar cal) {
		if (cal.isBaseCalendar()) {
			if (!baseCalendars.contains(cal)) {
				boolean found = findBaseCalendar(cal.getName(),null) != null;
				if (found)
					return;
...
//
	...
	public static final Object[] allBaseCalendars() {
		return allBaseCalendars(null);
	}
	public static final Object[] allBaseCalendars(Object obj) {
	...
	public static final WorkCalendar findBaseCalendar(String name,Object obj) {
		return getInstance().findBaseCalendar(name,false);
	}
	public static final WorkCalendar findBaseCalendarFromId(long id) {
		return getInstance().findBaseCalendar(id);
	}
