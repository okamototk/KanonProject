...
public class WorkDay extends CalendarEvent implements Comparable, Cloneable,Serializable {
	...
	protected WorkDay(long fromDate, long toDate,String description) {
		super(fromDate, toDate,description);
	}
	
	public WorkDay(long date,WorkingHours hours) {
		this(date,date);
 ...
 */
	...
	public static WorkDay deserialiseCompact(ObjectInputStream s) throws IOException, ClassNotFoundException{
		return new WorkDay(s.readLong(), s.readLong(), (String)s.readObject());
	}
