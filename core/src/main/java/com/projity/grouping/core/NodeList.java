...
public class NodeList extends ArrayList {
	...
	/* (non-Javadoc)
	 * @see com.projity.grouping.core.Node#getImpl()
	 */
	...
	public static List nodeListToImplList(Collection nodeList) {
		return filterNodeList(nodeList,true);
	}
	public static List filterNodeList(Collection nodeList, boolean extractImpl) {
	    return filterNodeList(nodeList,NotVoidFilter.getInstance(),extractImpl);
	}
	public static List nodeListToImplList(Collection nodeList,NodeFilter filter) {
		return filterNodeList(nodeList,filter,true);
	}
	public static List filterNodeList(Collection nodeList,NodeFilter filter, boolean extractImpl) {
		...
		while (i.hasNext()) {
			...
			if (!current.isVirtual()&&(filter==null||filter.evaluate(current)))
				implList.add(extractImpl?current.getImpl():current);
		}
		return implList;
	}
}