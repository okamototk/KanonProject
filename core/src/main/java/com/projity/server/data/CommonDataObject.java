...
public class CommonDataObject implements DataObject{
	...
	public static final long MAX_LOCAL_ID=10000000L;
...
//	}
    ...
    public static boolean isLocal(long uniqueId){
        return !Environment.isNoPodServer()&&uniqueId<MAX_LOCAL_ID;
    }
    ...
    public void renumber(IDGenerator idGenerator){
    	if (getUniqueId()!=SUMMARY_UNIQUE_ID) setUniqueId(idGenerator.getId(getUniqueId()));
    }
