...
public class ScheduleOption {
	...
	boolean keepTasksContiguous = Environment.isNoPodServer();
	...
	public final boolean isKeepTasksContiguous() {
		return keepTasksContiguous;
	}

	public final void setKeepTasksContiguous(
			boolean keepTasksContiguous) {
		this.keepTasksContiguous = keepTasksContiguous;
	}
