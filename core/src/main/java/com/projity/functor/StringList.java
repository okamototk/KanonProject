...
public class StringList implements Closure {
	...
	public static String commaSeparatedList(String[] array) {
		ArrayList l = new ArrayList();
		for (String s : array)
			l.add(s);
		return commaSeparatedList(l);
	}
	public static String commaSeparatedObjectList(Object[] array) {
		if (array == null)
			return "";
		ArrayList l = new ArrayList();
		for (Object s : array)
			l.add(s == null ? "null" : s.toString());
		return commaSeparatedList(l);
	}
	public static String commaSeparatedToStringList(Object[] array) {
		if (array == null)
			return "";
		ArrayList l = new ArrayList();
		for (Object s : array)
			l.add(s == null ? "null" : (ClassUtils.isBasicType(s.getClass()) ? s.toString() :  ToStringBuilder.reflectionToString(s)));
		return commaSeparatedList(l);
	}
 ...
 */	public static String repeat(String val, int times) {
 	...
 	public static int[] parseAsIntArray(String csvList) {
 		if (csvList == null || csvList.length() == 0)
 			return null;
 		String stringValues[] = csvList.split(",");
