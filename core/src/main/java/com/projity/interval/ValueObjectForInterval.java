 ...
 *
 */
public abstract class ValueObjectForInterval implements MutableHasStartAndEnd, DoubleValue, Comparable,Comparator, Serializable, Cloneable {
	...
	protected abstract void setPrimaryValue(double value);
	...
	public String toString() {
		return "Start: " + DateTime.shortString(getStart())  + " End: " + DateTime.shortString(getEnd()) + " Value:" + getPrimaryValue();
	}
...
//	    }
	...
	public void deserializeCompact(ObjectInputStream s,ValueObjectForIntervalTable parentTable) throws IOException, ClassNotFoundException  {
		setStart(s.readLong());
		setEnd(s.readLong());
		boolean hasTable=s.readBoolean();
//		if (hasTable){
