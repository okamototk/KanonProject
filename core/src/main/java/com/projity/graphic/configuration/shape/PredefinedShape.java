...
public class PredefinedShape {
	...
	public static final PredefinedShape QUARTER_HEIGHT_TOP = new PredefinedShape("QUARTER_HEIGHT_TOP", rectPoints, 1, .25, 0, -.375);
	...
	public static final PredefinedShape TRIANGLE_DOWN_LEFT = new PredefinedShape("TRIANGLE_DOWN_LEFT", new double[][] { { -.5, -.5 }, {  -.5, .3 }, { .25, -.5 }, });
	
	public static final PredefinedShape TRIANGLE_DOWN_RIGHT = new PredefinedShape("TRIANGLE_DOWN_RIGHT", new double[][] { { -.25, -.5 }, { .5, .3 }, { .5, -.5 }, });
	...
	public static final PredefinedShape[] MIDDLE_LIST = { FULL_HEIGHT, HALF_HEIGHT_TOP, HALF_HEIGHT_BOTTOM, HALF_HEIGHT_CENTER, QUARTER_HEIGHT_CENTER, QUARTER_HEIGHT_TOP };

	public static final PredefinedShape[] END_LIST = { SQUARE, DIAMOND, PENTAGON_UP, PENTAGON_DOWN, TRIANGLE_UP, TRIANGLE_DOWN, TRIANGLE_DOWN_LEFT, TRIANGLE_DOWN_RIGHT, TRIANGLE_RIGHT,
	...
	private static void initialize() {
		...
		add(TRIANGLE_UP);
		add(TRIANGLE_DOWN);
		add(TRIANGLE_DOWN_LEFT);
		add(TRIANGLE_DOWN_RIGHT);
		add(TRIANGLE_RIGHT);
		add(TRIANGLE_LEFT);
		add(ARROW_UP);
		add(ARROW_DOWN);
