...
//			System.out.println("field is null in SpreadSheetFieldArray addField : ");
	...
	public static Map<String,Object> convertFields(Object obj,String category,Transformer typeConverter){
		SpreadSheetFieldArray fieldArray=SpreadSheetFieldArray.getFromId(category,category);
		if (fieldArray!=null){
			...
			for (Iterator i=fieldArray.iterator();i.hasNext();){
				...
				if (typeConverter!=null) value=typeConverter.transform(value);
