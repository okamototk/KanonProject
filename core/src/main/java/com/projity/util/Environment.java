...
public class Environment {
	...
	private static boolean noPodServer = false;
	private static boolean testing = false;
	private static boolean importTesting = false;
	private static boolean updatingTimesheet = false;
	...
	public static void setProxyAuth(String proxyAuth) {
		Environment.proxyAuth = proxyAuth;
	}

	public static boolean isUpdatingTimesheet(){
		return updatingTimesheet;
	}

	public static boolean setUpdatingTimesheet( boolean updatingTimesheet){
		return Environment.updatingTimesheet = updatingTimesheet;
	}
	...
	public static void setImportTesting(boolean importTesting) {
		Environment.importTesting = importTesting;
	}
	public static boolean isImportTesting() {
		return importTesting;
	}
	public static boolean isNoPodServer() {
		return noPodServer;
	}
	public static void setNoPodServer(boolean noPodServer) {
		Environment.noPodServer = noPodServer;
	}
...
//		&& !Environment.isChinese());
    ...
    */
	...
	public static boolean isAddSummaryTask(){
		return Environment.isNoPodServer();
	}
	public static boolean isShowF1Links() {
		return !isNoPodServer();
	}
