...
public class Alert {
	...
	public static int confirmYesNo(Object messageObject, int defaultValue) {
		if (!allowPopups())
			return defaultValue;
	...
	public static int confirmYesNo(Object messageObject) {
		return confirmYesNo(messageObject,JOptionPane.YES_OPTION);
	}
	...
	public static boolean okCancel(Object messageObject) {
		if (!allowPopups()) {
			System.out.println(messageObject + " returning true");
			return true;
		}
	...
	public static boolean allowPopups() {
		return Environment.isClientSide() && !Environment.isBatchMode() && !Environment.isTesting();
	}
