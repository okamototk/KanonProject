...
public class CalendarOption implements java.io.Serializable{
	...
	Calendar defaultStartTime = DateTime.calendarInstance();
	Calendar defaultEndTime = DateTime.calendarInstance();
	 ...
	 */
	public void setDefaultEndTime(Calendar defaultEndTime) {
	...
	/**
	 * @param calendar The defaultStartTime to set.
	 */
	public void setDefaultStartTime(Calendar calendar) {
		System.out.println("Default start time is " + calendar.getTime());
