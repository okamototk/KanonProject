...
public abstract class NodeWalker extends SummaryVisitor {
	...
	/* (non-Javadoc)
	 * @see com.projity.grouping.core.field.SummaryVisitor#setField(com.projity.field.Field)
	 */
	...
	/* (non-Javadoc)
	 * @see com.projity.grouping.core.field.SummaryVisitor#setContext(com.projity.field.FieldContext)
	 */
	...
	public void setUseKey(boolean useKey) {
		super.setUseKey(useKey);
		visitor.setUseKey(useKey);
	}
