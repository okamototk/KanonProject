...
public class SessionFactory {
    ...
    public Session getSession(boolean local){
    	return getSession(local,DEFAULT_FORMAT);
    }
    public Session getSession(boolean local,int format){
    	//if (Environment.isNoPodServer())
    	//	local = true;
    	return local?getSession("local"):(format==NO_POD_FORMAT?getSession("serverImport"):getSession("server"));
    }
