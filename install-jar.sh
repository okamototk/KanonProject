...
%MAVEN_HOME%/bin/mvn install:install-file -Dfile=contrib/lib/jasperreports/jasperreports.jar -DgroupId=jasperreports -DartifactId=jasperreports -Dversion=custom  -Dpackaging=jar 
...
%MAVEN_HOME%/bin/mvn install:install-file -Dfile=contrib/lib/l2fprod-common-totd.jar  -DgroupId=com.l2fprod.common -DartifactId=l2fprod-common -Dversion=7.3 -Dpackaging=jar
