...
//				tc.setCellEditor(new SpreadSheetNameCellEditor(new SimpleEditor(String.class)));
				...
				if (field.hasOptions()) {
					...
					tc.setCellRenderer(new SpreadSheetCellRendererAdapter(new MoneyRenderer()));
				...
				} else if (field.isHyperlink()){
					tc.setCellRenderer(new SpreadSheetCellRendererAdapter(new HyperlinkRenderer()));
					tc.setCellEditor(new HyperlinkEditor(Hyperlink.class));
				} else if (field.isResourceNames()){
					tc.setCellRenderer(new SpreadSheetCellRendererAdapter(new SimpleRenderer()));
					tc.setCellEditor(new ResourceNamesEditor(String.class));
				}  else if (field.isScalar()){ 
					tc.setCellRenderer(new SpreadSheetCellRendererAdapter(new NumberRenderer()));
