...
public class ApplicationStartupFactory extends StartupFactory {
	...
	public ApplicationStartupFactory(HashMap opts) {
		Object noPodServer=opts.get("noPodServer");
		if (noPodServer!=null&&noPodServer.toString().toUpperCase().equals("TRUE")){
			Messages.setMetaBundle("com.serena.pod.configuration.meta_mariner");
			Environment.setNoPodServer(true);
		}
