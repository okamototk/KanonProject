...
import com.projity.pm.graphic.spreadsheet.SpreadSheet.SpreadSheetAction;
import com.projity.util.Environment;

/**
 *
 */
public class SpreadSheetPopupMenu extends JPopupMenu implements PopupMenuListener{
	   protected int row;
	    protected int col;
	    	...
	    	if (menuActionMap==null){
	    		...
	    		if (Environment.isNewLook()) {
		    		...
		    		if (Environment.isNoPodServer())
		    			menuActionMap.put(MenuActionConstants.ACTION_COMPLETE_AND_CLOSE,"tool.complete");
	    		} else {
			...
			for (Object o : getComponents()) {
				if (o instanceof JMenuItem) {
					...
					if (action instanceof SpreadSheetAction)
						((SpreadSheetAction) action).doPreShow((JMenuItem)o);
				}
			}
		}
}
