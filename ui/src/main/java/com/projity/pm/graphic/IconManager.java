...
public class IconManager {
	...
	private static URL getIconResource(String iconName) {
		...
		String extraIcons =  Messages.getMetaString("ExtraIcons");
		if (extraIcons != null)
			result = classLoader.getResource(extraIcons + iconName);
		return result;
	}

	public static URL getURL(String key) {
		ResourceBundle bundle = ResourceBundle
				.getBundle(Messages.getMetaString("ImagesBundlePath"),Locale.getDefault(),classLoader);
