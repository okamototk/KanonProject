...
public class HelpUtil implements KeyEventDispatcher {
	...
	public static final String helpTipImg = "<img src=\"" + IconManager.class.getResource("/toolbarButtonGraphics/general/Information16.gif")
	+ "\"> F1";
	// a tooltip with a help icon and F1
	public static final String helpTipHtml = "<html><img src=\"" + IconManager.class.getResource("/toolbarButtonGraphics/general/Information16.gif")
	+ "\"> F1</html>";
	public static void addHelp(Component c, String address) {
		if (getInstance().noHelp) return;
		if (Environment.isShowF1Links()) {
