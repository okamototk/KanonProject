...
public final class FeatureNotAvailableDialog extends AbstractDialog {
	private static final long serialVersionUID = 1L;
	public static void doDialog(Frame parent) {
		new FeatureNotAvailableDialog(parent).doModal();
	}

	private FeatureNotAvailableDialog(Frame parent) {
		super(parent, Messages.getString("Title.ProjityWarning"), true); //$NON-NLS-1$ //$NON-NLS-2$
	}
