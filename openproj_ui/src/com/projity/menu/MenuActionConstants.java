...
public interface MenuActionConstants {
	...
	public static final String ACTION_CANCEL_CHANGES          = "CancelChanges";
	public static final String ACTION_RELOAD                  = "Reload";
	public static final String ACTION_PULL_ACTUALS            = "PullActuals";
	public static final String ACTION_SUBSTITUTE_RESOURCE	  = "SubstituteResource";
	...
	public static final String ACTION_COMPLETE_AND_CLOSE	  = "CompleteAndClose";
	...
	public static final String ACTION_REINITIALIZE			=	"Reinitialize";
	public static final String ACTION_UNDO_STACK		=	"UndoStack";
